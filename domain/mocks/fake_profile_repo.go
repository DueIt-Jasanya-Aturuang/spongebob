...
type FakeProfileRepo struct {
	...
	StoreProfileStub        func(context.Context, *sql.Tx, model.Profile) (model.Profile, error)
	...
	UpdateProfileStub        func(context.Context, *sql.Tx, model.Profile) (*model.Profile, error)
...
func (fake *FakeProfileRepo) StoreProfile(arg1 context.Context, arg2 *sql.Tx, arg3 model.Profile) (model.Profile, error) {
...
func (fake *FakeProfileRepo) StoreProfileCalls(stub func(context.Context, *sql.Tx, model.Profile) (model.Profile, error)) {
	fake.storeProfileMutex.Lock()
	defer fake.storeProfileMutex.Unlock()
	fake.StoreProfileStub = stub
}

func (fake *FakeProfileRepo) StoreProfileArgsForCall(i int) (context.Context, *sql.Tx, model.Profile) {
	fake.storeProfileMutex.RLock()
	defer fake.storeProfileMutex.RUnlock()
...
func (fake *FakeProfileRepo) UpdateProfile(arg1 context.Context, arg2 *sql.Tx, arg3 model.Profile) (*model.Profile, error) {
...
func (fake *FakeProfileRepo) UpdateProfileCalls(stub func(context.Context, *sql.Tx, model.Profile) (*model.Profile, error)) {
	fake.updateProfileMutex.Lock()
	defer fake.updateProfileMutex.Unlock()
	fake.UpdateProfileStub = stub
}

func (fake *FakeProfileRepo) UpdateProfileArgsForCall(i int) (context.Context, *sql.Tx, model.Profile) {
	fake.updateProfileMutex.RLock()
	defer fake.updateProfileMutex.RUnlock()
