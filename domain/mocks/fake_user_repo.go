...
type FakeUserRepo struct {
	...
	UpdateUserStub        func(context.Context, *sql.Tx, model.User) (*model.User, error)
	...
	UpdateUsernameStub        func(context.Context, *sql.Tx, model.User) (*model.User, error)
...
func (fake *FakeUserRepo) UpdateUser(arg1 context.Context, arg2 *sql.Tx, arg3 model.User) (*model.User, error) {
...
func (fake *FakeUserRepo) UpdateUserCalls(stub func(context.Context, *sql.Tx, model.User) (*model.User, error)) {
	fake.updateUserMutex.Lock()
	defer fake.updateUserMutex.Unlock()
	fake.UpdateUserStub = stub
}

func (fake *FakeUserRepo) UpdateUserArgsForCall(i int) (context.Context, *sql.Tx, model.User) {
	fake.updateUserMutex.RLock()
	defer fake.updateUserMutex.RUnlock()
...
func (fake *FakeUserRepo) UpdateUsername(arg1 context.Context, arg2 *sql.Tx, arg3 model.User) (*model.User, error) {
...
func (fake *FakeUserRepo) UpdateUsernameCalls(stub func(context.Context, *sql.Tx, model.User) (*model.User, error)) {
	fake.updateUsernameMutex.Lock()
	defer fake.updateUsernameMutex.Unlock()
	fake.UpdateUsernameStub = stub
}

func (fake *FakeUserRepo) UpdateUsernameArgsForCall(i int) (context.Context, *sql.Tx, model.User) {
	fake.updateUsernameMutex.RLock()
	defer fake.updateUsernameMutex.RUnlock()
