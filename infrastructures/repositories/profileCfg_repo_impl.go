...
func (repo *ProfileCfgRepoImpl) GetProfileCfgByScheduler(ctx context.Context, model dto.ProfileCfgScheduler) (*[]model.ProfileCfg, error) {
	query := `SELECT id, profile_id, config_name, config_value, status, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by
...
func (repo *ProfileCfgRepoImpl) StoreProfileCfg(ctx context.Context, tx *sql.Tx, entity model.ProfileCfg) error {
	...
	if exists {
		return exceptions.ErrProfileConfigAlvailable
	}
...
func (repo *ProfileCfgRepoImpl) UpdateProfileCfg(ctx context.Context, tx *sql.Tx, entity model.ProfileCfg) error {
